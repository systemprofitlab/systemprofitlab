  ...
  return (
    <main className="site-shell">
      <section className="container-shell flex min-h-screen items-center py-20">
        <div className="panel-surface-strong mx-auto w-full max-w-3xl p-8 text-center sm:p-10">
          ...
          <div className="mx-auto mt-8 grid max-w-xl gap-3 sm:grid-cols-2">
            <div className="panel-surface px-4 py-5 text-sm font-medium text-slate-200">
              Source: {source}
            </div>
            <div className="panel-surface px-4 py-5 text-sm font-medium text-slate-200">
